...
public class ServiceGenerator implements IGenerator{
	...
	public ServiceGenerator(String servicePackageName,String modelPackageName,String objQueryObjectPackageName, String serviceOutputDir) {
	...
	protected void genModelContent(TableMeta tableMeta) {
		...
		String ret = Engine.use("forService").setSourceFactory(new ClassPathSourceFactory()).getTemplate(template).renderToString(data);
