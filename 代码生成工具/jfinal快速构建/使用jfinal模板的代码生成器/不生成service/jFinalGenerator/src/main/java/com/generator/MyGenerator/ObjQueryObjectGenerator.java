...
public class ObjQueryObjectGenerator implements IGenerator{
	...
	public ObjQueryObjectGenerator(String objQueryObjectPackageName, String objQueryObjectOutputDir) {
	...
	protected void genModelContent(TableMeta tableMeta) {
		Kv data = Kv.by("objQueryObjectPackageName", objQueryObjectPackageName);
		data.set("tableMeta", tableMeta);

		String ret = Engine.use("forObjQueryObject").setSourceFactory(new ClassPathSourceFactory()).getTemplate(template).renderToString(data);
	...
	protected void writeToFile(TableMeta tableMeta) throws IOException {
		...
		String target = objQueryObjectOutputDir + File.separator + tableMeta.modelName+ "QueryObject" + ".java";
