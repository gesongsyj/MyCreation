...
public class ControllerGenerator implements IGenerator{
	...
	public ControllerGenerator(String controllerPackageName,String modelPackageName,String objQueryObjectPackageName, String controllerOutputDir) {
	...
	protected void genModelContent(TableMeta tableMeta) {
		...
		String ret = Engine.use("forController").setSourceFactory(new ClassPathSourceFactory()).getTemplate(template).renderToString(data);
