...
protected String template = "/com/generator/MyGenerator/templates/QueryObject.jf";
	...
	protected String queryObjectClassName = "QueryObject";
	
	public QueryObjectGenerator(String queryObjectPackageName,String modelPackageName, String queryObjectOutputDir) {
	...
	public void setMappingKitClassName(String queryObjectClassName) {
		if (StrKit.notBlank(queryObjectClassName)) {
			this.queryObjectClassName = StrKit.firstCharToUpperCase(queryObjectClassName);
		}
	}
	...
	public void generate(List<TableMeta> tableMetas) {
		...
		Kv data = Kv.by("queryObjectPackageName", queryObjectPackageName);
		data.set("queryObjectClassName", queryObjectClassName);
	...
	protected void writeToFile(String ret) {
		...
		try {
			...
			String target = queryObjectOutputDir + File.separator + queryObjectClassName + ".java";
